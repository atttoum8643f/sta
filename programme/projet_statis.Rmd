...
\[
\begin{pmatrix}
1.0000 & 0.9992 & 0.9989 \\
0.9992 & 1.0000 & 0.9991 \\
0.9989 & 0.9991 & 1.0000 
\end{pmatrix}
\]
...
for (i in 1:3) {
  Ft <- cmp(filtre,i)$F_k
  representation_graph_ind(Ft, 1, 2, aff_noms = TRUE,cex_titre = 0.80)
}
```
...
representation_graph_tab(filtre, 1, 2)
