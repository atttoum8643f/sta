...
representation_graph_tab(lst, 1, 2, repel = TRUE)
F1_theme <- cmp(lst,1)$F_k
lambda_k <- cmp(lst,1)$lambda[1]
spect_F1_theme <- vecval_prop(F1_theme)$val_prop
...
\[
Z = \begin{pmatrix}
1,0000 & 0,1511 & 0,4838 \\
0,1511 & 1,0000 & 0.8272 \\
0.4838 & 0.8272 & 1.0000 
\end{pmatrix}, \quad
U = \begin{pmatrix}
-0,4093 & 0,8659 & 0,2875 \\
-0,6074 & -0,4937 & 0,6223 \\
-0,6808 & -0.0801 & -0,7281 
\end{pmatrix}, \quad
\nu = \begin{pmatrix}
2,0289  \\
0,8691  \\
...
\[F_1 = \begin{pmatrix}
-2.5217 & 0.3060 & 1.8027 \\
0.3060 & -1.2028 & -0.3205 \\
1.8027 & -0.3205 & -1.8876
\end{pmatrix}, \quad
F_2 = \begin{pmatrix}
-0.5801 & -1.0969 & 0.3701 \\
-1.0969 & 1.8769 & 0.7659 \\
0.3701 & 0.7659 & -0.3299
\end{pmatrix}\\ 
F_3 = \begin{pmatrix}
0.2497 & -0.2872 & 0.1416 \\
-0.2872 & -0.6014 & 0.3731 \\
0.1416 & 0.3731 & 0.1003
\end{pmatrix}
\]
